...
def afterlogin_view(request):
    if is_admin(request.user):
        ...
        # Handling unauthorized access by returning an appropriate error message
        return HttpResponse("Unauthorized access. You are not authorized to access this page.")
